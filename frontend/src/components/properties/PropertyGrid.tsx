      ...
      return (
        <div className="space-y-4">
          {Array.from({ length: 6 }).map((_, i) => (
            ...
            >
              <div className="sm:w-60 md:w-72 lg:w-80 h-44 bg-muted rounded-xl shrink-0" />
    ...
    <AnimatePresence mode="popLayout">
      <motion.div
        ...
        className={
          viewMode === "list"
            ? "space-y-4"
            : "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-5"
        }
      >
