...
export default function PropertyDetailsView({
  ...
  if (loading) {
    return (
      <div className={isDashboard ? "py-4 space-y-6" : "pt-24 pb-16"}>
        <div className={isDashboard ? "" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"}>
          <div className="animate-pulse space-y-6">
            <div className="h-6 bg-muted rounded w-32" />
            <div className="h-[400px] sm:h-[550px] bg-muted rounded-3xl" />
  ...
  if (!property) {
    return (
      <div className={isDashboard ? "py-12 text-center" : "pt-24 pb-16 text-center"}>
        <div className={isDashboard ? "" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"}>
  ...
  return (
    <div className={isDashboard ? "space-y-8" : "pt-20 sm:pt-24 pb-20"}>
      <div className={isDashboard ? "space-y-8" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10"}>
        {/* Back Navigation Bar */}
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3.5">
            ...
            <div className="hidden lg:flex lg:col-span-3 flex-col gap-3 h-[580px] xl:h-[640px]">
