      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 rounded-xl">
            ...
            <DropdownMenuSeparator />
            {unreadCount > 0 ? (
              <DropdownMenuItem onClick={() => window.location.href = '/admin/messages'} className="cursor-pointer gap-3 p-3">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => window.location.href = '/admin/messages'} className="cursor-pointer justify-center text-emerald-600 font-medium">
              View all messages
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
